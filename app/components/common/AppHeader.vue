...
<template>
	<header
		...
		<div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
			<!-- Augmentation de la hauteur du header pour plus d'espace -->
			<div class="flex justify-between items-center py-5 md:py-7">
				<!-- Logo et Nom du site -->
				<NuxtLink
					to="/"
					...
					<div class="flex flex-col">
						<span
							class="font-serif font-bold text-xl md:text-2xl bg-gradient-to-r from-stone-100 to-emerald-100 bg-clip-text text-transparent">
							NDILBE DOUVIC TOYOUM
						</span>
						<span class="text-xs font-light text-stone-300">
			...
			<div
				...
				<div class="container mx-auto px-4 py-4 space-y-2">
					<NuxtLink
						...
						:class="[
							route.path === item.to ? 'bg-emerald-800/50 text-white' : '',
						]"
