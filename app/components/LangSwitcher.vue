    ...
    <div class="relative" ref="dropdownRef">
        ...
        <button
            ...
            :class="[
                ...
                variant === 'ghost'
                    ? 'text-stone-300 hover:text-white hover:bg-white/10 rounded-md'
                    : 'bg-emerald-700/30 text-stone-200 hover:text-white hover:bg-emerald-700/50 rounded-md border border-emerald-600/30',
            ]"
        ...
        <Transition
            ...
            <div
                v-if="isOpen"
                class="absolute right-0 mt-2 w-48 bg-emerald-800/95 backdrop-blur-md rounded-lg shadow-xl border border-emerald-600/50 overflow-hidden z-50">
                <div class="py-1">
                    <button
                        ...
                        :class="[
                            ...
                            locale === item.code
                                ? 'bg-stone-100/20 text-white'
                                : 'text-stone-200 hover:text-white hover:bg-emerald-700/50',
                        ]">
                        ...
                        <UIcon
                            ...
                            class="w-4 h-4 ml-auto text-stone-100" />
                    </button>
                </div>
            </div>
        </Transition>
