            ...
            <div class="absolute inset-0 flex items-center justify-center">
                <UContainer class="text-center text-white">
                    ...
                    <p class="text-xl lg:text-2xl text-emerald-100 mb-8 max-w-3xl mx-auto">
                        Une sélection de travaux personnels et professionnels qui illustrent mes compétences et ma passion pour le développement web
                    </p>
        ...
        <UContainer class="py-16">
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
                        <div>
                            ...
                            <div class="text-emerald-700 dark:text-emerald-300">Projets réalisés</div>
                        </div>
                        <div>
                            <div class="text-3xl font-bold text-emerald-600 dark:text-emerald-400 mb-2">
                                {{ uniqueTechnologies.length }}
                            </div>
                            <div class="text-emerald-700 dark:text-emerald-300">Technologies utilisées</div>
                        </div>
                        <div>
                            <div class="text-3xl font-bold text-emerald-600 dark:text-emerald-400 mb-2">
                                {{ clientProjects.length }}
                            </div>
                            <div class="text-emerald-700 dark:text-emerald-300">Clients satisfaits</div>
                        </div>
                        <div>
                            <div class="text-3xl font-bold text-emerald-600 dark:text-emerald-400 mb-2">
                                {{ openSourceProjects.length }}
                            </div>
                            <div class="text-emerald-700 dark:text-emerald-300">Projets open source</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-12">
                <div v-if="filteredProjects.length === 0" class="text-center py-12">
                    <Icon name="i-heroicons-folder-open" class="w-16 h-16 text-emerald-300 dark:text-emerald-600 mx-auto mb-4" />
            ...
            <!-- CTA Final -->
            <UCard class="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white shadow-lg border-0">
                <div class="text-center py-12">
                    <h2 class="text-3xl font-bold mb-4">
                        Intéressé par une collaboration ?
                    </h2>
                    <p class="text-emerald-100 mb-8 max-w-2xl mx-auto">
                        Je suis toujours ouvert à discuter de nouveaux projets et idées créatives.
                        N'hésitez pas à me contacter pour transformer vos idées en réalité !
                    </p>
...
useHead({
    ...
    meta: [
        {
            name: "description",
            content: "Découvrez l'ensemble de mes projets réalisés avec passion et expertise. Développeur Full-Stack spécialisé Vue.js, Laravel et Node.js.",
        },
    ],
});
</script>